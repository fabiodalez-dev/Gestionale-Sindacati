<?php
// autocomplete_aziende_detailed.php
...
$query = "SELECT DISTINCT id, nome_azienda AS label FROM aziende WHERE nome_azienda LIKE ? ORDER BY nome_azienda ASC LIMIT 10";
$params = ['%' . $term . '%'];
$types = 's';
