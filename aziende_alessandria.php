<?php
// aziende_alessandria.php - Lista aziende (consultazione) dal database "adlcobas_alessandria"
ini_set('display_errors', 1);
ini_set('display_startup_errors', 1);
error_reporting(E_ALL);

// Includi il file di configurazione indipendente (config_alessandria.php)
require_once 'config_alessandria.php';
...
if ($isAjax) {
    ...
    if ($aziende->num_rows > 0) {
        while ($row = $aziende->fetch_assoc()) {
            ...
            <tr>
                <td>
                    <a href="azienda_alessandria.php?id=<?php echo sanitizeForHTML($row['id']); ?>">
...
<head>
    <meta charset="UTF-8">
    <title>Lista Aziende - Consultazione Alessandria</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-flex flex-wrap justify-content-between align-items-center mt-4">
                        <h1 class="h3 mb-4 text-gray-800">Lista Aziende - Consultazione Alessandria</h1>
                        <div class="mt-2">
