...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link href="<?php echo htmlspecialchars($base_url, ENT_QUOTES, 'UTF-8'); ?>theme/css/sb-admin-2.min.css?v=2.6" rel="stylesheet">
    ...
    <!-- Custom Styles -->
    <link href="<?php echo htmlspecialchars($base_url, ENT_QUOTES, 'UTF-8'); ?>styles.css?v=2.6" rel="stylesheet">
